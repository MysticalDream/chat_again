 ...
 * @version 1.0
 * <br><b>PackageName:</b> client.view
 * <br><b>ClassName:</b> StageController
 * <br><b>Date:</b> 2021年6月16日 下午2:10:50
 */
public class StageController {
	 ...
	 * @param owner
	 * @return <br/>
	 *         <b>Date:</b> 2021年6月10日 上午11:08:57
	 */
	public boolean show(String showName, String owner) {
		Stage temp = this.getStage(showName);
		if (temp.getModality() != Modality.WINDOW_MODAL) {
			temp.initModality(Modality.WINDOW_MODAL);
		}
		if (temp.getOwner() == null) {
			temp.initOwner(this.getStage(owner));
		}
		temp.showAndWait();
		return true;
	}
	 ...
	 * @param name
	 * @return <br/>
	 *         <b>Date:</b> 2021年6月10日 上午11:03:24
	 */
